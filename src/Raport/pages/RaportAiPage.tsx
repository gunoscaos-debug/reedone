      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-soft p-6">
            <h2 className="text-lg font-semibold text-slate-800 dark:text-white mb-4">Pilih Siswa</h2>
            <StudentSelector 
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-soft p-6">
            ...
            <div className="flex flex-col gap-4">
              <textarea
                ...
                placeholder="Masukkan prompt untuk AI atau kosongkan untuk menggunakan prompt otomatis..."
                className="flex-1 p-3 border border-slate-300 dark:border-slate-600 rounded-lg min-h-[100px] bg-transparent focus:ring-2 focus:ring-primary-500"
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-soft p-6 min-h-full">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold text-slate-800 dark:text-white">Input Nilai Mata Pelajaran</h2>
              {selectedSiswa && (
            ...
            {selectedSiswa ? (
              ...
              <div className="text-center py-16 flex flex-col items-center justify-center h-full">
                <User className="mx-auto text-5xl text-slate-300 dark:text-slate-600 mb-4" />
                <p className="font-semibold text-slate-600 dark:text-slate-400">Pilih Siswa Terlebih Dahulu</p>
                <p className="text-sm text-slate-500 dark:text-slate-500">Silakan pilih siswa dari panel di sebelah kiri untuk mulai menginput nilai.</p>
              </div>
            )}
          </div>
        </div>
